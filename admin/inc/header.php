    ...
    <div class="container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft logo">
                    <img src="img/logo_pnj.png" alt="Logo" width="200px" />
                </div>
                <div class="floatleft middle">
                    <h1>Niềm tin và phong cách</h1>
                    <p>www.pnjshop.com</p>
                </div>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-form-style"><a href="customerlist.php"><span>Thông tin khách hàng</span></a></li>
                ...
                <li class="ic-charts"><a href="chartlist.php"><span>Thông kê</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>